...
e(c,!1);g(d);a(d);b.resolve()}catch(f){k.Log.error("Initialize failed.  message:"+f.message,f),b.reject(f)}},function(a){b.reject(a)});return b},loadCBSPackage:function(c){var d=new k.Deferred;0<=p.indexOf(c)?d.resolve():b(c).done(function(b){try{var f=e([b],!0);g(f);a(f)}catch(h){k.Log.error("Parse CBS package failed. package file:"+c,h),d.reject(h)}d.resolve()},function(a){d.reject(a)});return d},test:{parseCBSInDocument:l,getScopes:e,Ks:g,Kv:a}}})(window);(function(i){function j(a){c.Kh.K15(a);a.parentNode.removeChild(a);c.Debugger.nodeRemoved(a)}function h(a,b,d,e){try{var f=c.K1F.getValueOnPath(d,a);if(!f)return c.Log.error("Can't find template selector:"+a),null;var g=f.apply(b,[d,b]);!g&&!e&&c.Log.error("The template selector returns NULL. template selector:"+a);return g}catch(h){return c.Log.error("Call template selector failed. template selector:"+a,h),null}}function g(a,b,d){if(!d||!d.template&&!d.templateSelector)c.Log.error("No valid template is specified for 'content' access point. current node:"+
c.KX.KY(a));else{var e=function(e,f){if(d&&d[f]){var g=c.K1F.getValueOnPath(b,d[f]);try{g.apply(a,[e,b])}catch(h){c.Log.warning("Raise "+f+" event failed.",h)}}},f=d.template,g=!1;d.templateSelector&&(null===b||"undefined"===typeof b||(f=h(d.templateSelector,a,b,!0)),g=!0);var i=a.childNodes[0];if(i){if(!(i.__knot&&i.__knot.dataContext===b))if(null===b||"undefined"===typeof b||null===f||"undefined"===typeof f)j(i),e(i,"@removed");else if(g||c.Kh.K10(f)?
(j(i),i=null,f&&(i=c.Kh.createFromTemplate(f,b,a)),i&&(a.appendChild(i),c.Kh.hasDataContext(i)||c.Kh.setDataContext(i,b),c.Debugger.nodeAdded(i),e(i,"@added"))):c.Kh.setDataContext(i,b),i)i.__knot||(i.__knot={}),i.__knot.dataContext=b}else if(!(null===b||"undefined"===typeof b||null===f||"undefined"===typeof f))if(f=c.Kh.createFromTemplate(f,b,a))a.appendChild(f),c.Kh.hasDataContext(f)||c.Kh.setDataContext(f,
b),e(f,"@added"),c.Debugger.nodeAdded(f)}}function e(a,b,d,e,f,g){b||(b=[]);for(var i=0;i<b.length;i++){var o;a:{for(var n=i;n<a.children.length;n++)if(a.children[n].__knot&&a.children[n].__knot.dataContext===b[i]){o=a.children[n];break a}o=null}if(o){if(Array.prototype.indexOf.call(a.children,o)!==i){a.removeChild(o);var n=a,q=i;n.children.length===q?n.appendChild(o):n.insertBefore(o,n.children[q])}}else{if(e&&(d=h(e,a,b[i]),!d))continue;if(n=c.Kh.createFromTemplate(d,b[i],a)){o=a;var q=
n,r=i;o.children.length===r?o.appendChild(q):o.insertBefore(q,o.children[r]);c.Kh.hasDataContext(n)||c.Kh.setDataContext(n,b[i]);c.Debugger.nodeAdded(n);f&&f.apply(a,[n,b[i]])}}}for(i=a.children.length-1;i>=b.length;i--)j(a.children[i]),g&&g.apply(a,[a.children[i]])}function d(a,b,d){!d||!d.template&&!d.templateSelector?c.Log.error("No valid template is specified for 'foreach' access point. current node:"+c.KX.KY(a)):e(a,b,d.template,d.templateSelector,
c.K1F.getValueOnPath(a,d["@added"]),c.K1F.getValueOnPath(a,d["@removed"]))}var c=i.Knot.K1M(),f=[];f["input.value"]="change";f["textarea.value"]="change";f["input.checked"]="change";f["select.selectedIndex"]="change";f["select.value"]="change";f["*.clientWith"]="resize";f["*.clientHeight"]="resize";f["*.scrollTop"]="scroll";f["*.scrollLeft"]="scroll";c.KX={KY:function(a){var b=a.tagName;a.id?b+="[#"+a.id+"]":a.className&&(b+="["+a.className.split(" ").filter(function(a){return a.trim()!==
""}).map(function(a){return"."+a}).join(" ")+"]");return b},getSelectorFromAPDescription:function(a){a=c.K1F.K1K(a,".");return c.K1F.trim(a[0])},getPropertyNameFromAPDescription:function(a){a=c.K1F.K1K(a,".");if(1<a.length)return a.slice(1).join(".")},getPropertyFromElement:function(a,b){return!a?void 0:c.K1F.getValueOnPath(a,b)},Kd:function(a){if(0<a.indexOf("(")){var b=c.K1F.K1J(a,0,"(",")");if(b)try{var d=a.substr(b.start+1,
b.end-b.start-1);return document.querySelector(d)}catch(e){c.Log.error("Query selector failed.",e)}else c.Log.error("Unknown selector:"+a)}else return document.querySelector(a)}};c.Kf={doesSupport:function(a,b){return"#"===b[0]?!0:"!"===b[0]?!1:a instanceof HTMLElement},getValue:function(a,b){if("@"!==b[0]&&("#"===b[0]&&(a=c.KX.Kd(c.KX.getSelectorFromAPDescription(b)),b=c.KX.getPropertyNameFromAPDescription(b)),!c.K1F.K1G(b,"content")&&
!c.K1F.K1G(b,"foreach")))return c.KX.getPropertyFromElement(a,b)},setValue:function(a,b,e,f){"@"===b[0]?"function"!==typeof e?c.Log.error("Event listener must be a function!"):a&&a.addEventListener(b.substr(1),function(b){e.apply(a.__knot.dataContext,[b,a])}):("#"===b[0]&&(a=c.KX.Kd(c.KX.getSelectorFromAPDescription(b)),b=c.KX.getPropertyNameFromAPDescription(b)),c.K1F.K1G(b,"content"))?g(a,e,f):c.K1F.K1G(b,"foreach")?
...
for(var b=a.tagName.toLowerCase()+"."+b,b=f[b].split(","),g=0;g<b.length;g++)a.addEventListener(b[g],d);("input"===a.tagName.toLowerCase()||"textarea"===a.tagName.toLowerCase())&&(e&&e.immediately&&("1"===e.immediately||"true"===e.immediately.toLowerCase()))&&a.addEventListener("keyup",d)},stopMonitoring:function(a,b,d,e){"#"===b[0]&&(a=c.KX.Kd(c.KX.getSelectorFromAPDescription(b)),b=c.KX.getPropertyNameFromAPDescription(b));for(var b=a.tagName.toLowerCase()+
"."+b,b=f[b].split(","),g=0;g<b.length;g++)a.removeEventListener(b[g],d);("input"===a.tagName.toLowerCase()||"textarea"===a.tagName.toLowerCase())&&(e&&e.immediately&&("1"===e.immediately||"true"===e.immediately.toLowerCase()))&&a.removeEventListener("keyup",d)},syncItems:e};c.K3.registerAPProvider(c.Kf);c.Kg={doesSupport:function(a,b){return b&&("!"===b[0]&&(b=b.substr(1)),"#"===b[0])?!0:a instanceof HTMLElement},getValue:function(a,b){if("!"===b[0]&&(b=b.substr(1),
"#"===b[0]&&(a=c.KX.Kd(c.KX.getSelectorFromAPDescription(b)),b=c.KX.getPropertyNameFromAPDescription(b)),a))return!a.__knot_errorStatusInfo||!a.__knot_errorStatusInfo[b]?null:a.__knot_errorStatusInfo[b].currentStatus},setValue:function(a,b,d,e){if("!"===b[0]&&(b=b.substr(1),"#"===b[0]&&(a=c.KX.Kd(c.KX.getSelectorFromAPDescription(b)),b=c.KX.getPropertyNameFromAPDescription(b)),a&&(d||a.__knot_errorStatusInfo&&a.__knot_errorStatusInfo[b]&&
a.__knot_errorStatusInfo[b].K1O)))if(a.__knot_errorStatusInfo||(a.__knot_errorStatusInfo={}),a.__knot_errorStatusInfo[b]||(a.__knot_errorStatusInfo[b]={}),a.__knot_errorStatusInfo[b].currentStatus!==d){a.__knot_errorStatusInfo[b].currentStatus=d;if(a.__knot_errorStatusInfo[b].K1O)for(var f=a.__knot_errorStatusInfo[b].K1O,g=0;g<f.length;g++)try{f[g].apply(a,[b,d])}catch(h){c.Log.warning("Call error status changed callback failed.",h)}if(e&&e["@error"])if(f=c.K1F.getValueOnPath(null,
e["@error"]),!f||"function"!==typeof f)c.Log.error("'"+e["@error"]+"' must be a function.");else try{f.apply(a,[b,d])}catch(j){c.Log.error("Call AP error event handler '"+e["@error"]+"' failed.",j)}}},doesSupportMonitoring:function(a,b){return"!"===b[0]},monitor:function(a,b,d){if("!"===b[0]){b=b.substr(1);if("#"===b[0]){var e=c.KX.getSelectorFromAPDescription(b),a=c.KX.Kd(e);if(!a){c.Log.warning("Failed to bind to error status, target is not found.  target selector:"+
e);return}b=c.KX.getPropertyNameFromAPDescription(b)}a.__knot_errorStatusInfo||(a.__knot_errorStatusInfo={});a.__knot_errorStatusInfo[b]||(a.__knot_errorStatusInfo[b]={});a.__knot_errorStatusInfo[b].K1O||(a.__knot_errorStatusInfo[b].K1O=[]);a.__knot_errorStatusInfo[b].K1O.push(d)}},stopMonitoring:function(a,b,d){"#"===b[1]&&(a=c.KX.Kd(c.KX.getSelectorFromAPDescription(b.substr(1))),b=c.KX.getPropertyNameFromAPDescription(b.substr(1)));
a.__knot_errorStatusInfo&&(a.__knot_errorStatusInfo[b]&&a.__knot_errorStatusInfo[b].K1O)&&(d=a.__knot_errorStatusInfo[b].K1O.indexOf(d),0<=d&&a.__knot_errorStatusInfo[b].K1O.splice(d,1))},getErrorStatusInformation:function(a,b){if(a.__knot_errorStatusInfo)for(var c in a.__knot_errorStatusInfo)a.__knot_errorStatusInfo[c]&&a.__knot_errorStatusInfo[c].currentStatus&&b.push({node:a,accessPointName:c,error:a.__knot_errorStatusInfo[c].currentStatus});for(c=0;c<a.children.length;c++)this.getErrorStatusInformation(a.children[c],
b)}};c.K3.registerAPProvider(c.Kg,!0)})(window);(function(i){function j(a){if(!a)return null;for(var b=0;b<a.length;b++)if("dataContext"===a[b].leftAP.description)return a[b];return null}function h(a,b){a.__knot?b.__knot=JSON.parse(JSON.stringify(a.__knot)):delete b.__knot;for(var c=0;c<a.children.length;c++)h(a.children[c],b.children[c])}function g(){var a,b;for(b in c){(function(){var e=b;c[e].objectObserveCallback=function(b,f,g){b=c[e].options;if(f)for(a=0;a<b.length;a++)d.K3.KG(f,null,b[a]);for(a=0;a<b.length;a++)d.K3.KF(g,
